  ...
  return (
    <main className="overflow-hidden bg-[#f8f2ea] text-[#44362f]">
      <section className="relative flex min-h-screen items-center justify-center px-5 py-16 text-center sm:px-8">
        ...
        <motion.div initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9 }} className="relative mx-auto max-w-4xl">
          ...
          <div className="mt-10 flex flex-col justify-center gap-3 sm:flex-row">
            <Link href="/convites" className="inline-flex h-12 items-center justify-center gap-2 rounded-full bg-[#596653] px-8 text-sm font-medium text-white transition hover:-translate-y-0.5 hover:bg-[#46513f]">
              <TicketCheck className="size-4" /> Comprar convite
            </Link>
      ...
      <section className="px-5 py-24 text-center sm:px-8 sm:py-32">
        <motion.div {...fadeUp} className="mx-auto max-w-2xl"><Heart className="mx-auto size-7 fill-[#9f6d65] text-[#9f6d65]" /><h2 className="mt-6 font-serif text-4xl sm:text-5xl">Queremos celebrar com você</h2><p className="mt-5 leading-7 text-[#665a52]">Garanta seu convite e informe o nome de cada acompanhante para a lista da recepção.</p><Link href="/convites" className="mt-8 inline-flex h-12 items-center justify-center gap-2 rounded-full bg-[#596653] px-8 text-sm font-medium text-white transition hover:bg-[#46513f]"><TicketCheck className="size-4" /> Comprar convite</Link></motion.div>
      </section>
